...
export default function GenericModal({ data, mode, onClose, onSave }) {
  const [formData, setFormData] = useState(data);
  const [imageFields, setImageFields] = useState(data.images || []);
              ...
              <div className="col-12">
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="/assets/images/data/thumbnail/example.jpg"
                  />
                </div>
              </div>
            </div>
