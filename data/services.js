export const services = [
  {
    ...
    title: 'Service sur stand',
    text: 'Du sourire à l’entrée à l’ambiance musicale, en passant par la sécurité et le service, chaque détail compte pour créer un événement fluide et mémorable.',
    items: ['Hôtes d’accueil', 'Caterin', 'DJ', 'Sécurité Gardiennage'],
  },
  {
    width: 60,
    height: 64,
    ...
    items: ['Stand VR & AR', 'Datas ROI', 'Collecte de leads'],
  },
  {
    width: 50,
    height: 64,
